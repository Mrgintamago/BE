...
// Unique index only applies when user exists (not for guest reviews)
// Note: Guest reviews can have multiple reviews per product since we don't track them uniquely
